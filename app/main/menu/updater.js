...
autoUpdater.on('update-available', () => {
  dialog.showMessageBox({
    type: 'warning',
    title: 'Update Found',
    checkboxLabel: 'I understand the risks and want to update dWallet automatically.',
    message: 'The most secure way to update dWallet is to download the latest release from GitHub, verify, and install. This update process will attempt to do that automatically.',
...
autoUpdater.on('update-not-available', () => {
  dialog.showMessageBox({
    title: 'No dWallet Updates',
    message: 'Current dWallet version is up-to-date.'
  });
  updater.enabled = true;
  updater = null;
});
...
autoUpdater.on('update-downloaded', () => {
  dialog.showMessageBox({
    ...
    message: 'Updates downloaded, dWallet will be quit so it can update to the latest stable release...'
  }, () => {
