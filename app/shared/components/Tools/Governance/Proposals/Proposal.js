        ...
        <Segment attached>
          {(isSupporting)
            ? (
              <Message
                color="green"
                header="This wallet has approved this proposal."
                content="The stake weighted value of this wallet has been recorded as approving this proposal."
                icon="checkmark"
              />
            )
            : false
          ...
          {(isAgainst)
            ? (
              <Message
                color="red"
                header="This wallet has opposed this proposal."
                content="The stake weighted value of this wallet has been recorded as opposing this proposal."
                icon="x"
              />
            )
            : false
